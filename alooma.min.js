...
-1==u.indexOf("Mozilla"),c={},y=s,S={api_host:("https:"==m.location.protocol?"https://":"http://")+"api.alooma.com",cross_subdomain_cookie:n,persistence:"cookie",persistence_name:"",cookie_name:"",loaded:C(),store_google:n,save_referrer:n,test:s,verbose:s,img:s,track_pageview:n,debug:s,track_links_timeout:300,cookie_expiration:365,upgrade:s,disable_persistence:s,disable_cookie:s,secure_cookie:s,ip:n,property_blacklist:[],truncate:255},K=s;(function(){var a=Q.bind,b=J.forEach,d=J.indexOf,e=Array.isArray,
f={};c.bind=function(b,d){var e,f;if(a&&b.bind===a)return a.apply(b,B.call(arguments,1));if(!c.Db(b))throw new TypeError;e=B.call(arguments,2);return f=function(){if(!(this instanceof f))return b.apply(d,e.concat(B.call(arguments)));ctor.prototype=b.prototype;var a=new ctor;ctor.prototype=q;var c=b.apply(a,e.concat(B.call(arguments)));return Object(c)===c?c:a}};c.qc=function(a){for(var b in a)"function"===typeof a[b]&&(a[b]=c.bind(a[b],a))};var k=c.c=function(a,d,c){if(a!=q)if(b&&a.forEach===b)a.forEach(d,
c);else if(a.length===+a.length)for(var e=0,k=a.length;e<k&&!(e in a&&d.call(c,a[e],e,a)===f);e++);else for(e in a)if(G.call(a,e)&&d.call(c,a[e],e,a)===f)break};c.s=function(a){a&&c.Za(a)&&(a=a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"));return a};c.extend=function(a){k(B.call(arguments,1),function(b){for(var d in b)void 0!==b[d]&&(a[d]=b[d])});return a};c.isArray=e||function(a){return"[object Array]"===D.call(a)};c.Db=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return s}};
...
Object(a)&&!c.isArray(a)};c.R=function(a){if(c.k(a)){for(var b in a)if(G.call(a,b))return s;return n}return s};c.e=function(a){return void 0===a};c.Za=function(a){return"[object String]"==D.call(a)};c.Gc=function(a){return"[object Date]"==D.call(a)};c.Hc=function(a){return"[object Number]"==D.call(a)};c.vb=function(a){c.c(a,function(b,d){c.Gc(b)?a[d]=c.Cc(b):c.k(b)&&(a[d]=c.vb(b))});return a};c.Cc=function(a){function b(a){return 10>a?"0"+a:a}return a.getUTCFullYear()+"-"+b(a.getUTCMonth()+1)+"-"+
b(a.getUTCDate())+"T"+b(a.getUTCHours())+":"+b(a.getUTCMinutes())+":"+b(a.getUTCSeconds())};c.m=function(a){return function(){try{a.apply(this,arguments)}catch(b){p.ca("Implementation error. Please contact support@alooma.com.")}}};c.Nc=function(a){for(var b=["identify","_check_and_handle_notifications","_show_notification"],d=0;d<b.length;d++)a.prototype[b[d]]=c.m(a.prototype[b[d]])};c.va=function(a){var b={};c.c(a,function(a,e){c.Za(a)&&0<a.length&&(b[e]=a)});return b};c.truncate=function(a,b){var d;
"string"===typeof a?d=a.slice(0,b):c.isArray(a)?(d=[],c.c(a,function(a){d.push(c.truncate(a,b))})):c.k(a)?(d={},c.c(a,function(a,f){d[f]=c.truncate(a,b)})):d=a;return d};c.W=function(){return function(a){function b(a,f){var k="",j=0,i=j="",i=0,g=k,h=[],r=f[a];r&&"object"===typeof r&&"function"===typeof r.toJSON&&(r=r.toJSON(a));switch(typeof r){case "string":return c(r);case "number":return isFinite(r)?""+r:"null";case "boolean":case "null":return""+r;case "object":if(!r)return"null";k+="    ";h=
...
z.vendor,window.opera)})},Kc:function(a){return c.va({mp_page:a,mp_referrer:m.referrer,mp_browser:c.info.ba(u,z.vendor,window.opera),mp_platform:c.info.ab()})}};var p={log:function(){if(y&&!c.e(v)&&v)try{v.log.apply(v,arguments)}catch(a){c.c(arguments,function(a){v.log(a)})}},error:function(){if(y&&!c.e(v)&&v){var a=["Alooma error:"].concat(c.ha(arguments));try{v.error.apply(v,a)}catch(b){c.c(a,function(a){v.error(a)})}}},ca:function(){if(!c.e(v)&&v){var a=["Alooma error:"].concat(c.ha(arguments));
try{v.error.apply(v,a)}catch(b){c.c(a,function(a){v.error(a)})}}}};w.prototype.sa=C();w.prototype.Ta=C();w.prototype.Na=C();w.prototype.Ya=function(a){this.Gb=a;return this};w.prototype.U=function(a,b,d,e){var f=this,k=c.Ac(a);if(0==k.length)p.error("The DOM query ("+a+") returned 0 elements");else return c.c(k,function(a){c.S(a,this.Ib,function(a){var c={},j=f.sa(d,this),k=f.Gb.a("track_links_timeout");f.Ta(a,this,c);window.setTimeout(f.Pb(e,j,c,n),k);f.Gb.U(b,j,f.Pb(e,j,c))})},this),n};w.prototype.Pb=
...
c.Bb(F,w);F.prototype.Ta=function(a,b,c){c.element=b;a.preventDefault()};F.prototype.Na=function(a,b){setTimeout(function(){b.element.submit()},0)};l.prototype.I=function(){var a={};c.c(this.props,function(b,d){c.zb(R,d)||(a[d]=b)});return a};l.prototype.load=function(){if(!this.disabled){var a=this.v.parse(this.name);a&&(this.props=c.extend({},a))}};l.prototype.bd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.v.parse(d),this.v.remove(d),this.v.remove(d,
...
j=this.Z("$add"),i=this.Z("$union"),g=this.Z("$append",[]);"__mps"===d?(c.extend(f,e),this.P("$add",e),this.P("$union",e)):"__mpso"===d?c.c(e,function(a,b){b in k||(k[b]=a)}):"__mpa"===d?c.c(e,function(a,b){b in f?f[b]+=a:(b in j||(j[b]=0),j[b]+=a)},this):"__mpu"===d?c.c(e,function(a,b){c.isArray(a)&&(b in i||(i[b]=[]),i[b]=i[b].concat(a))}):"__mpap"===d&&g.push(e);p.log("ALOOMA PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");p.log(b);this.save()};l.prototype.P=function(a,b){var d=this.O(a);c.e(d)||
...
S,b,{name:d,token:a,callback_fn:("alooma"===d?d:"alooma."+d)+"._jsc"}));this._jsc=C();this.Fa=[];this.Ga=[];this.Ea=[];this.Y={disable_all_events:s,identify_called:s};this.persistence=this.cookie=new l(this.config);this.G({distinct_id:c.Zb()},"")};h.prototype.oa=function(){this.a("loaded")(this);this.a("track_pageview")&&this.Qb()};h.prototype.dc=function(){c.c(this.Fa,function(a){this.La.apply(this,a)},this);c.c(this.Ga,function(a){this.o.apply(this,a)},this);delete this.Fa;delete this.Ga};h.prototype.La=
function(a,b){if(this.a("img"))return p.error("You can't use DOM tracking functions with img = true."),s;if(!K)return this.Fa.push([a,b]),s;var c=(new a).Ya(this);return c.U.apply(c,b)};h.prototype.pa=function(a,b){if(c.e(a)||q===a)return q;if(H)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.a("callback_fn")+'["'+e+'"]';d[e]=function(c){delete d[e];a(c,b)};return f};h.prototype.o=function(a,b,d){if(L)this.Ga.push(arguments);else{var e=this.a("verbose");b.verbose&&
(e=n);this.a("test")&&(b.test=1);e&&(b.verbose=1);this.a("img")&&(b.img=1);if(!H)if(d)b.callback=d;else if(e||this.a("test"))b.callback="(function(){})";b.ip=this.a("ip")?1:0;b._=(new Date).getTime().toString();a+="?"+c.Yb(b);if("img"in b){var f=m.createElement("img");f.src=a;m.body.appendChild(f)}else if(H){var g=new XMLHttpRequest;g.open("GET",a,n);g.withCredentials=n;g.onreadystatechange=function(){if(4===g.readyState)if(200===g.status)d&&(e?d(c.ka(g.responseText)):d(Number(g.responseText)));else{var a=
"Bad HTTP status: "+g.status+" "+g.statusText;p.error(a);d&&(e?d({status:0,error:a}):d(0))}};g.send(q)}else{f=m.createElement("script");f.type="text/javascript";f.async=n;f.defer=n;f.src=a;var j=m.getElementsByTagName("script")[0];j.parentNode.insertBefore(f,j)}}};h.prototype.Ha=function(a){function b(a,b){c.c(a,function(a){this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],f=[],g=[];c.c(a,function(a){a&&(d=a[0],"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!=
d.indexOf("track")&&"function"===typeof this[d]?g.push(a):f.push(a))},this);b(e,this);b(f,this);b(g,this)};h.prototype.push=function(a){this.Ha([a])};h.prototype.disable=function(a){"undefined"===typeof a?this.Y.xc=n:this.Ea=this.Ea.concat(a)};h.prototype.U=function(a,b,d){if(c.e(a))p.error("No event name provided to alooma.track");else if(this.gb(a))"undefined"!==typeof d&&d(0);else{b=b||{};b.token=this.a("token");var e=this.persistence.Mc(a);c.e(e)||(b.$duration=parseFloat((((new Date).getTime()-
e)/1E3).toFixed(3)));this.persistence.eb(m.referrer);this.a("store_google")&&this.persistence.Sb();this.a("save_referrer")&&this.persistence.za(m.referrer);b=c.extend({},c.info.I(),this.persistence.I(),b);e=this.a("property_blacklist");c.isArray(e)?c.c(e,function(a){delete b[a]}):p.error("Invalid value for property_blacklist config: "+e);a=c.truncate({event:a,properties:b},this.a("truncate"));e=c.W(a);e=c.Pa(e);p.log("ALOOMA REQUEST:");p.log(a);this.o(this.a("api_host")+"/track/",{data:e},this.pa(d,
a));return a}};h.prototype.Zc=function(a,b){var d={};a&&(d=a.properties||{});d.token=this.a("token");this.persistence.eb(m.referrer);this.a("store_google")&&this.persistence.Sb();this.a("save_referrer")&&this.persistence.za(m.referrer);var d=c.extend({},c.info.I(),this.persistence.I(),d),e=this.a("property_blacklist");c.isArray(e)?c.c(e,function(a){delete d[a]}):p.error("Invalid value for property_blacklist config: "+e);e=a||{};e.properties=d;var e=c.truncate(e,this.a("truncate")),f=c.W(e),f=c.Pa(f);
p.log("ALOOMA REQUEST:");p.log(e);this.o(this.a("api_host")+"/track/",{data:f},this.pa(b,e));return e};h.prototype.Qb=function(a){if(c.e(a))a=m.location.href;this.U("mp_page_view",c.info.Kc(a))};h.prototype.ad=function(){return this.La.call(this,A,arguments)};h.prototype.$c=function(){return this.La.call(this,F,arguments)};h.prototype.Xc=function(a){c.e(a)?p.error("No event name provided to alooma.time_event"):this.gb(a)||this.persistence.Sc(a)};h.prototype.ga=function(a,b){this.persistence.ga(a,
b)};h.prototype.G=function(a,b,c){this.persistence.G(a,b,c)};h.prototype.ya=function(a){this.persistence.ya(a)};h.prototype.Ka=function(a,b){var c={};c[a]=b;this.ga(c)};h.prototype.Wa=function(a,b,c,e,f,g){a!=this.Q()&&a!=this.ta("__alias")&&(this.ya("__alias"),this.Ka("distinct_id",a));this.fb(this.Q());this.Y.xb=n;this.people.gc(b,c,e,f,g)};h.prototype.Q=function(){return this.ta("distinct_id")};h.prototype.pc=function(a,b){if(a===this.ta("$people_distinct_id"))return p.ca("Attempting to create alias for existing People user - aborting."),
-2;var d=this;c.e(b)&&(b=this.Q());if(a!==b)return this.Ka("__alias",a),this.U("$create_alias",{alias:a,distinct_id:b},function(){d.Wa(a)});p.error("alias matches current distinct_id - skipping api call.");this.Wa(a);return-1};h.prototype.Ic=function(a){this.Ka("mp_name_tag",a)};h.prototype.Lb=function(a){if(c.k(a))c.extend(this.config,a),this.a("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.a("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),
this.persistence&&this.persistence.Tb(this.config),y=y||this.a("debug")};h.prototype.a=function(a){return this.config[a]};h.prototype.ta=function(a){return this.persistence.props[a]};h.prototype.toString=function(){var a=this.a("name");"alooma"!==a&&(a="alooma."+a);return a};h.prototype.gb=function(a){return c.Cb(u)||this.Y.xc||c.zb(this.Ea,a)};h.prototype.fb=function(a){if(a&&!this.Y.xb&&!this.a("disable_notifications")){p.log("ALOOMA NOTIFICATION CHECK");var b=this;this.o(this.a("api_host")+"/decide/",
{verbose:n,version:"1",lib:"web",token:this.a("token"),distinct_id:a},this.pa(function(a){a.notifications&&0<a.notifications.length&&b.nb.call(b,a.notifications[0])}))}};h.prototype.nb=function(a){(new g(a,this)).show()};o.prototype.Ja=function(a){this.d=a};o.prototype.set=function(a,b,d){var e={},f={};c.k(a)?(c.c(a,function(a,b){this.$(b)||(f[b]=a)},this),d=b):f[a]=b;this.na("save_referrer")&&this.d.persistence.za(m.referrer);f=c.extend({},c.info.Lc(),this.d.persistence.Ec(),f);e.$set=f;return this.o(e,
...
[],a)};o.prototype.wc=function(){if(this.ib())return this.o({$delete:this.d.Q()});p.error("alooma.people.delete_user() requires you to call identify() first")};o.prototype.toString=function(){return this.d.toString()+".people"};o.prototype.o=function(a,b){a.$token=this.na("token");a.$distinct_id=this.d.Q();var d=c.vb(a),e=c.truncate(d,this.a("truncate")),d=c.W(d),d=c.Pa(d);if(!this.ib())return this.ec(a),c.e(b)||(this.na("verbose")?b({status:-1,error:q}):b(-1)),e;p.log("ALOOMA PEOPLE REQUEST:");p.log(e);
this.d.o(this.na("api_host")+"/engage/",{data:d},this.d.pa(b,e));return e};o.prototype.na=function(a){return this.d.a(a)};o.prototype.ib=function(){return this.d.Y.xb===n};o.prototype.ec=function(a){"$set"in a?this.d.persistence.A("$set",a):"$set_once"in a?this.d.persistence.A("$set_once",a):"$add"in a?this.d.persistence.A("$add",a):"$append"in a?this.d.persistence.A("$append",a):"$union"in a?this.d.persistence.A("$union",a):p.error("Invalid call to _enqueue():",a)};o.prototype.gc=function(a,b,d,
e,f){var g=this,j=c.extend({},this.d.persistence.O("$set")),i=c.extend({},this.d.persistence.O("$set_once")),h=c.extend({},this.d.persistence.O("$add")),m=this.d.persistence.O("$append"),l=c.extend({},this.d.persistence.O("$union"));!c.e(j)&&c.k(j)&&!c.R(j)&&(g.d.persistence.P("$set",j),this.set(j,function(b,d){0==b&&g.d.persistence.A("$set",j);c.e(a)||a(b,d)}));!c.e(i)&&c.k(i)&&!c.R(i)&&(g.d.persistence.P("$set_once",i),this.Mb(i,function(a,b){0==a&&g.d.persistence.A("$set_once",i);c.e(e)||e(a,b)}));
!c.e(h)&&c.k(h)&&!c.R(h)&&(g.d.persistence.P("$add",h),this.Ab(h,function(a,d){0==a&&g.d.persistence.A("$add",h);c.e(b)||b(a,d)}));!c.e(l)&&c.k(l)&&!c.R(l)&&(g.d.persistence.P("$union",l),this.Rb(l,function(a,b){0==a&&g.d.persistence.A("$union",l);c.e(f)||f(a,b)}));if(!c.e(m)&&c.isArray(m)&&m.length){for(var o=m.length-1;0<=o;o--){var p=m.pop();g.append(p,function(a,b){0==a&&g.d.persistence.A("$append",p);c.e(d)||d(a,b)})}g.d.persistence.save()}};o.prototype.$=function(a){return"$distinct_id"===a||
"$token"===a};h.bc=function(a,b){c.qc(this);this.Oa=b;this.bb=this.Oa.persistence;this.C=c.s(a.id);this.Fb=c.s(a.message_id);this.body=(c.s(a.body)||"").replace(/\n/g,"<br/>");this.vc=c.s(a.cta)||"Close";this.da=c.s(a.cta_url)||q;this.Xa=c.s(a.image_url)||q;this.ea=c.s(a.type)||"takeover";this.style=c.s(a.style)||"light";this.J=c.s(a.thumb_image_url)||q;this.title=c.s(a.title)||"";this.Aa=c.s(a.video_url)||q;this.ia=g.ac;this.V=g.$b;this.ra=n;if(!this.da)this.da="#dismiss",this.ra=s;this.u="mini"===
this.ea;if(!this.u)this.ea="takeover";this.Jc=!this.u?g.X:g.Ba;this.mb();this.ua=this.hc();this.kc()};var g=h.bc;g.K=200;g.w="alooma-notification";g.ja=0.6;g.F=25;g.la=200;g.X=388;g.Ba=420;g.z=85;g.Ca=5;g.H=60;g.Da=Math.round(g.H/2);g.ac=595;g.$b=334;g.prototype.show=function(){var a=this;this.mb();this.p?(this.jc(),this.ic(),this.lc(this.cc)):setTimeout(function(){a.show()},300)};g.prototype.Sa=c.m(function(){this.Eb||this.kb({invisible:n});var a=this.Uc?this.h("video"):this.N();if(this.Ub)this.mc("bg",
"visible"),this.L(a,"exiting"),setTimeout(this.lb,g.K);else{var b,c,e;this.u?(b="right",c=20,e=-100):(b="top",c=g.F,e=g.la+g.F);this.ma([{q:this.h("bg"),l:"opacity",start:g.ja,i:0},{q:a,l:"opacity",start:1,i:0},{q:a,l:b,start:c,i:e}],g.K,this.lb)}});g.prototype.L=c.m(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});g.prototype.mc=c.m(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.h(a));
if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});g.prototype.ma=c.m(function(a,b,c,e){var f=this,g=s,h,i;h=1*new Date;var l,e=e||h;l=h-e;for(h=0;h<a.length;h++){i=a[h];if("undefined"===typeof i.D)i.D=i.start;if(i.D!==i.i){var g=n,m=i.i>=i.start?1:-1;i.D=i.start+(i.i-i.start)*l/b;if("opacity"!==i.l)i.D=Math.round(i.D);if(0<m&&i.D>=i.i||0>m&&i.D<=i.i)i.D=i.i}}if(g){for(h=0;h<a.length;h++)i=a[h],i.q&&(i.q.style[i.l]=""+i.D+("opacity"===
i.l?"":"px"));setTimeout(function(){f.ma(a,b,c,e)},10)}else c&&c()});g.prototype.cc=c.m(function(){var a=this;if(!this.Vc&&!this.hb()[this.C])this.Vc=n,this.p.appendChild(this.fa),setTimeout(function(){var b=a.N();if(a.Ub)a.u||a.L("bg","visible"),a.L(b,"visible"),a.jb();else{var c,e,f;a.u?(c="right",e=-100,f=20):(c="top",e=g.la+g.F,f=g.F);a.ma([{q:a.h("bg"),l:"opacity",start:0,i:g.ja},{q:b,l:"opacity",start:0,i:1},{q:b,l:c,start:e,i:f}],g.K,a.jb)}},100),c.S(a.h("cancel"),"click",function(b){b.preventDefault();
a.Sa()}),c.S(a.h("button")||a.h("mini-content"),"click",function(b){b.preventDefault();a.T?(a.Ma("$campaign_open",{$resource_type:"video"}),a.nc()):(a.Sa(),a.ra&&a.Ma("$campaign_open",{$resource_type:"link"},function(){window.location.href=a.da}))})});g.prototype.h=function(a){return m.getElementById(g.w+"-"+a)};g.prototype.N=function(){return this.h(this.ea)};g.prototype.hb=function(){return this.bb.props.__cmpns||(this.bb.props.__cmpns={})};g.prototype.M=function(a,b){return this.B[a]&&this.B[a]<=
b};g.prototype.hc=function(){var a=[];this.u?(this.J=this.J||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.J)):(this.Xa?(a.push(this.Xa),this.yb='<img id="img" src="'+this.Xa+'"/>'):this.yb="",this.J?(a.push(this.J),this.Ob='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+this.J+'" width="'+g.H+'" height="'+g.H+'"/><div id="thumbspacer"></div>'):this.Ob="");return a};g.prototype.ic=function(){var a="",b="",c="";this.fa=
m.createElement("div");this.fa.id=g.w+"-wrapper";if(this.u)a='<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>'+this.body+'</div></div></div></div></div><div id="mini-border"></div></div>';else{var a=this.ra||this.T?"":'<div id="button-close"></div>',e=this.T?'<div id="button-play"></div>':"";this.M("ie",7)&&(e=a="");a='<div id="takeover">'+this.Ob+
...
"margin-top":g.z+"px","border-radius":"6px",opacity:"0.25","background-color":"#fff","z-index":"-1","box-shadow":d},"#mini-icon":{position:"relative",display:"inline-block",width:"75px",height:g.z+"px","border-radius":"3px 0 0 3px","background-color":this.g.aa,background:"linear-gradient(135deg, "+this.g.pb+" 0%, "+this.g.aa+" 100%)",transition:"background-color "+f},"#mini:hover #mini-icon":{"background-color":this.g.$a},"#mini:hover #mainbox":{"background-color":this.g.$a},"#mini-icon-img":{position:"absolute",
"background-image":"url("+this.J+")",width:"48px",height:"48px",top:"20px",left:"12px"},"#content":{padding:"30px 20px 0px 20px"},"#mini-content":{"text-align":"left",height:g.z+"px",cursor:"pointer"},"#img":{width:"328px","margin-top":"30px","border-radius":"5px"},"#title":{"max-height":"600px",overflow:"hidden","word-wrap":"break-word",padding:"25px 0px 20px 0px","font-size":"19px","font-weight":"bold",color:this.g.xa},"#body":{"max-height":"600px","margin-bottom":"25px",overflow:"hidden","word-wrap":"break-word",
...
"#video-noflip":{position:"relative",top:2*-this.V+"px"},"#video-flip":{"backface-visibility":"hidden",transform:"rotateY(180deg)"},"#video":{position:"absolute",width:this.ia-1+"px",height:this.V+"px",top:g.F+"px","margin-top":"100px",left:"50%","margin-left":Math.round(-this.ia/2)+"px",overflow:"hidden","border-radius":"5px","box-shadow":b,transform:"translateZ(1px)",transition:"opacity "+f+", top "+f},"#video.exiting":{opacity:"0.0",top:this.V+"px"},"#video-holder":{position:"absolute",width:this.ia-
1+"px",height:this.V+"px",overflow:"hidden","border-radius":"5px"},"#video-frame":{"margin-left":"-1px",width:this.ia+"px"},"#video-controls":{opacity:"0",transition:"opacity 0.5s"},"#video:hover #video-controls":{opacity:"1.0"},"#video .video-progress-el":{position:"absolute",bottom:"0",height:"25px","border-radius":"0 0 0 5px"},"#video-progress":{width:"90%"},"#video-progress-total":{width:"100%","background-color":this.g.Qa,opacity:"0.7"},"#video-elapsed":{width:"0","background-color":"#6cb6f5",
opacity:"0.9"},"#video #video-time":{width:"10%",right:"0","font-size":"11px","line-height":"25px",color:this.g.cb,"background-color":"#666","border-radius":"0 0 5px 0"}};this.M("ie",8)&&c.extend(a,{"* html #overlay":{position:"absolute"},"* html #bg":{position:"absolute"},"html, body":{height:"100%"}});this.M("ie",7)&&c.extend(a,{"#mini #body":{display:"inline",zoom:"1",border:"1px solid "+this.g.qa},"#mini #body-text":{padding:"20px"},"#mini #mini-icon":{display:"none"}});var b="backface-visibility,border-radius,box-shadow,opacity,perspective,transform,transform-style,transition".split(","),
...
e.appendChild(f);f.setAttribute("type","text/css");f.styleSheet?f.styleSheet.cssText=d:f.textContent=d})(a,h)};g.prototype.kc=c.m(function(){if(this.Aa){var a=this;a.Xb="postMessage"in window;m.createElement("div");a.da=a.Aa;var b=a.Aa.match(/(?:youtube(?:-nocookie)?\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i),c=a.Aa.match(/vimeo\.com\/.*?(\d+)/i);if(b){if(a.T=n,a.Wb=b[1],a.Xb)window.onYouTubeIframeAPIReady=function(){a.h("video-frame")&&a.ob()},b=m.createElement("script"),
b.src="//www.youtube.com/iframe_api",c=m.getElementsByTagName("script")[0],c.parentNode.insertBefore(b,c)}else if(c)a.T=n,a.Vb=c[1];if(a.M("ie",7)||a.M("firefox",3))a.T=s,a.ra=n}});g.prototype.jb=c.m(function(){function a(a,b){var c={};if(m.defaultView&&m.defaultView.getComputedStyle)c=m.defaultView.getComputedStyle(a,q);else if(a.currentStyle)c=a.currentStyle;return c[b]}var b=this;c.S(b.h("bg"),"click",function(){b.Sa()});if(this.C){var d=this.h("overlay");d&&"hidden"!==a(d,"visibility")&&"none"!==
...
h();e.push(g)}this.M("ie",7)&&setTimeout(function(){var b=n;for(f=0;f<e.length;f++)e[f].complete||(b=s);b&&a&&(a(),a=q)},500)}};g.prototype.lb=c.m(function(){window.clearInterval(this.oc);this.fa.style.visibility="hidden";this.p.removeChild(this.fa)});g.prototype.mb=function(){function a(a){if(a in e)return n;if(!c)for(var a=a[0].toUpperCase()+a.slice(1),a=["O"+a,"Webkit"+a,"Moz"+a],b=0;b<a.length;b++)if(a[b]in e)return n;return s}function b(a){return(a=z.userAgent.match(a))&&a[1]}this.B={};this.B.chrome=
...
m.documentElement.clientHeight);var c=this.B.ie,e=m.createElement("div").style;this.Ub=this.p&&a("transition")&&a("transform");this.Va=(33<=this.B.chrome||15<=this.B.firefox)&&this.p&&a("backfaceVisibility")&&a("perspective")&&a("transform")};g.prototype.nc=c.m(function(){function a(){window.YT&&window.YT.loaded&&b.ob();b.Uc=n;b.N().style.visibility="hidden"}var b=this,c=[{q:b.N(),l:"opacity",start:1,i:0},{q:b.N(),l:"top",start:g.F,i:-500},{q:b.h("video-noflip"),l:"opacity",start:0,i:1},{q:b.h("video-noflip"),
l:"top",start:2*-b.V,i:0}];if(b.u){var e=b.h("bg"),f=b.h("overlay");e.style.width="100%";e.style.height="100%";f.style.width="100%";b.L(b.N(),"exiting");b.L(e,"visible");c.push({q:b.h("bg"),l:"opacity",start:0,i:g.ja})}b.h("video-holder").innerHTML=b.ed;b.Va?(b.L("flipper","flipped"),setTimeout(a,g.K)):b.ma(c,g.K,a)});g.prototype.Ma=function(a,b,d){this.C?(b=b||{},b=c.extend(b,{campaign_id:this.C,message_id:this.Fb,message_type:"web_inapp",message_subtype:this.ea}),this.Oa.track(a,b,d)):d&&d.call()};
g.prototype.ob=c.m(function(){var a=this;if(!a.fd){a.fd=n;var b=a.h("video-elapsed"),d=a.h("video-time"),e=a.h("video-progress");new window.YT.Player(g.w+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/60),c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}var h=f.target,i=h.getDuration();g(0);a.oc=window.setInterval(function(){var a=h.getCurrentTime();b.style.width=100*(a/i)+"%";g(a)},250);c.S(e,
"click",function(a){a=Math.max(0,a.pageX-e.getBoundingClientRect().left);h.seekTo(i*a/e.clientWidth,n)})}}})}});c.toArray=c.ha;c.isObject=c.k;c.JSONEncode=c.W;c.JSONDecode=c.ka;c.isBlockedUA=c.Cb;c.isEmptyObject=c.R;c.info=c.info;c.info.device=c.info.ub;c.info.browser=c.info.ba;c.info.properties=c.info.I;h.prototype.init=h.prototype.Ya;h.prototype.disable=h.prototype.disable;h.prototype.time_event=h.prototype.Xc;h.prototype.track=h.prototype.U;h.prototype.track_custom_event=h.prototype.Zc;h.prototype.track_links=
h.prototype.ad;h.prototype.track_forms=h.prototype.$c;h.prototype.track_pageview=h.prototype.Qb;h.prototype.register=h.prototype.ga;h.prototype.register_once=h.prototype.G;h.prototype.unregister=h.prototype.ya;h.prototype.identify=h.prototype.Wa;h.prototype.alias=h.prototype.pc;h.prototype.name_tag=h.prototype.Ic;h.prototype.set_config=h.prototype.Lb;h.prototype.get_config=h.prototype.a;h.prototype.get_property=h.prototype.ta;h.prototype.get_distinct_id=h.prototype.Q;h.prototype.toString=h.prototype.toString;
...
o.prototype.Yc;o.prototype.clear_charges=o.prototype.uc;o.prototype.delete_user=o.prototype.wc;o.prototype.toString=o.prototype.toString;c.Nc(h);var x={};(function(){I=1;t=window.alooma;c.e(t)?p.ca("'alooma' object not initialized. Ensure you are using the latest version of the Alooma JS Library along with the snippet we provide."):t.__loaded||t.config&&t.persistence?p.error("Alooma library has already been downloaded at least once."):1.1>(t.__SV||0)?p.ca("Version mismatch; please ensure you're using the latest version of the Alooma code snippet."):
(c.c(t._i,function(a){a&&c.isArray(a)&&(x[a[a.length-1]]=E.apply(this,a))}),O(),t.init(),c.c(x,function(a){a.oa()}),N())})()})();
})();
